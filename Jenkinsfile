pipeline {
	...
	environment {
		GOOGLE_PROJECT_ID = "spheric-backup-343616"
		GOOGLE_PROJECT_NAME = "My First Project"
		GOOGLE_APPLICATION_CREDENTIALS = credentials('service_account_total')
		GOOGLE_CLOUD_KEYFILE_JSON = credentials('service_account_total')
	}
	stages {
